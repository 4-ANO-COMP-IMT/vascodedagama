      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/champions-stadium.png'), // Insira o caminho da imagem
          ...
          child: appProvider.isLoggedIn
              ? Column(
                  ...
                  children: [
                    ...
                    style: TextStyle(fontSize: 20, color: Colors.white)), // Contador de tentativas
                    Text('Pontuação: ${gameState.score}',
                    style: TextStyle(fontSize: 20, color: Colors.white),), // Exibe a pontuação
                    Text('Recorde: ${gameState.highScore}',
                    style: TextStyle(fontSize: 20, color: Colors.white),), // Exibe o recorde
                    const SizedBox(height: 40),
                                  ...
                                  children: [
                                        ...
                                        _debounce = Timer(const Duration(milliseconds: 500), () {
                                          setState(() {
                                            ...
                                            gameState.suggestions = appProvider.players
                                                ...
                                                && !gameState.guessHistory.any((guess) => guess.player.id == player['id']))
                                                .toList();
                                          });
                                        });
                                      },
                                    ...
                                    FadeTransition(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 20,
                                          color: _isCorrectGuess ? Colors.green : const Color.fromARGB(255, 244, 48, 34),
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return ListTile(
                                            title: Text(player['name'], style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                                            onTap: () {
                                              setState(() {
                                              ...
                                              gameState.checkGuess(context, player['id'], appProvider.secretPlayer!['id']);
                                    ...
                                    gameState.guessHistory.isNotEmpty
                                        ? Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('Histórico de Palpites:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                                              Container(
                                                height: 300,
                                                child: ListView.builder(
                                                  reverse: false,
                                                      ...
                                                      child: ListTile(
                                                        ...
                                                        title: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            getValidationWidget('Nacionalidade', guess.player.country, appProvider.secretPlayer!['country']),
